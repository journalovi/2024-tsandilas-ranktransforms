...
### Interpreting interactions
 We discussed how the scale of the data affects the interpretation of interactions [@Loftus:1978]. In particular, when distributional assumptions are violated, a positive test for interaction may not indicate a genuine interaction. Larger sample sizes do not mitigate this issue; instead, the ratio of false positives increases with sample size because the test becomes more sensitive. We demonstrated that rank transformations do not address this problem, as they also struggle to correctly interpret interactions in the presence of parallel main effects. 
