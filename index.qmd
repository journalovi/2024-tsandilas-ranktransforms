...
In addition to the main sections of the paper, we provide two appendices: [Appendix I](appendix-I.html) presents results from additional Monte Carlo experiments, and Appendix II details analysis alternatives for representative dataset examples.
...
Specifically for the log-normal and binomial distributions, we present result for a wider range of their parameters in [Appendix I](appendix-I.html#log-normal).
...
Our tests in [Appendix I](appendix-I.html#missing) also show that ART's Type I error rates increase further in unbalanced designs with missing data.
