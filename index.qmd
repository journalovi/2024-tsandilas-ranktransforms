...
## Type I errors accross experimental designs {#extra}
Our third experiment investigates the generalizability of the aforementioned results to other experimental designs involving two or three factors. We assess five out of the six ratio scales examined in Section 5. We exclude the Cauchy distribution and replace it by a 5-level ordinal scale with random thresholds, as detailed in Section 6.
