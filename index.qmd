...
### Interactions under non-linear transformations
As we discussed in the previous section, ART emerged in the early 90s as a remedy to the rank transform procedure. 
As @higgins:1990 explained, non-linear transformations such as the rank transform change the structure of interactions. As a result, *"interaction may exist in the transformed data but not in the original data, or vice versa"* [@higgins:1990]. ART aims to correct this problem. However, the distributions of observed measures may also be the result of non-linear transformations, which often makes the interpretation of observed interaction effects problematic. 

Consider again our introduction's illustrative example. 

there is another problem that the literature on the ART procedure does not address. 

 Distributions of observed measures are often  

@Loftus:1978    

### Ordinal scales and discretization issues
