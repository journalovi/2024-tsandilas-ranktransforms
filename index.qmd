...
While partial $\eta^2$ is the most commonly used effect size measure, we chose to base our analysis on Cohen's $f$, as its expected value is proportional to the real magnitude of effect. However, $\eta^2$ can be directly derived from Cohen's $f$ as follows:
...
(On Likert scales) I moved this paragraph to the discussion.
