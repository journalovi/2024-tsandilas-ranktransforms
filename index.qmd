...
distr = c("likert5", "likert7", "likert20", "likert5B", "likert7B", "likert20B")
...
plotErrorGrid(df, max = 40, "rateX1X2", xvar = "sd_ratio", xlab = expression(ratio~of~standard~deviations~between~levels~of~factor~X[1]))
```
...
```{r, echo=FALSE, fig.height=5, fig.width = 9, warning=FALSE}
plotErrorGrid(df, max = 40, "rateX2",  xvar = "sd_ratio", xlab = expression(ratio~of~standard~deviations~between~levels~of~factor~X[1]))
```
