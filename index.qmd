...
We express our gratitude to Pierre Dragicevic for introducing us to the concept of removable interactions [@Loftus:1978;@Wagenmakers:2012]. Additionally, we extend our thanks to Haiko Lüpsen for his invaluable assistance in evaluating his implementation of the multifactorial generalizations of the van der Waerden test, as well as the Kruskal-Wallis and Friedman tests. Finally, we are thankful to Sophie Siestrup and Daniel Martin for their responsiveness and for generously sharing their data with us. 
