...
plotlyErrorByDesign_v3(df, xlab = "magnitude of main effect", var = "rates", xvar = "effect", max = 7.1, nticks=8, cbPalette = palette)
```
Positives rate ($\alpha = .05$) for the **main effect** as a function of the magnitude $a_1$ of the main effect of $X_1$ ($n = 20$)
:::